...
const getTasks = asyncHandler(async (req, res) => {
  ...
  if (!tasks) {
    throw new ApiError(404, "No Task Found on this Project");
  }
...
const deleteTask = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, {}, "Task delted successfully"));
});
...
const createSubTask = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, created, "Subtask created successfully"));
});
...
const updateSubTask = asyncHandler(async (req, res) => {
  ...
  if (typeof isCompleted !== "undefined") update.isCompleted = isCompleted;

  const updated = await subTask.findByIdAndUpdate(subTaskId, update, {
    new: true,
  });
